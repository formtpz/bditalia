...
PERMISOS_POR_PERFIL = {
    1: ["Dashboards","RRHH","Carga Asignaciones", "Produccion", "Eventos", "Historial", "Correcciones", "Cerrar Sesion"],
    2: ["RRHH", "Cerrar Sesion"],
    3: ["Produccion", "Asignación", "Eventos", "Historial","Correcciones", "Cerrar Sesion"]
}
